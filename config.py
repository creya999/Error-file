...
class Config:
    SECRET_KEY = os.environ.get('SECRET_KEY', 'adbl-instant-card-secret-2024')
    ...
    if USE_SQLITE:
        ...
        SQLALCHEMY_DATABASE_URI = f"sqlite:///{os.path.join(BASE_DIR, 'adbl_test.db')}"
    else:
        # SQL Server — production (Windows)
        DB_SERVER   = os.environ.get('DB_SERVER', 'localhost')
        DB_PORT     = os.environ.get('DB_PORT', '')
        DB_NAME     = os.environ.get('DB_NAME', 'adbl_instant_card')
